...
class Fragmentshandle : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fragmentshandle)
    ...
    private fun setupViewPager(viewpager: ViewPager) {
        ...
        // is a title of tab
        adapter.addFragment(fragment1(), "Login")
        adapter.addFragment(fragment2(), "Signup")
